# [Concrete CMS](https://www.concretecms.com) Cheat Sheet V8+
...
- [Concrete CMS Cheat Sheet V8+](#concrete-cms-cheat-sheet-v8)
  ...
  - [System Operations](#system-operations)
    ...
    - [Misc.](#misc)
      ...
      - [Programmatically display login/logout link](#programmatically-display-loginlogout-link)
...
// page parameters (url parameters)
...
// medium: eg 'MMM d, y' - 'August 20, 2014')
// short: eg 'M/d/yy' - '8/20/14'
// skeleton pattern prefixed by '~': e.g. '~yMd'
...
#### Programmatically display login/logout link
```PHP
